...
window.GM = (function () {
  ...
  const trends = {
    ...
    licenses: [
      { name:"Disney — estreno live action", pct:88, window:"Jul 2026", potential:"Alto", reason:"Estreno coincide con 3ª ventana; tracción histórica en infantil y juvenil." },
      { name:"Festival de música verano", pct:64, window:"Ene 2026", potential:"Medio", reason:"Pico de demanda en gráficas de banda durante enero." },
      { name:"Serie streaming juvenil T2", pct:57, window:"Feb 2026", potential:"Medio", reason:"Audiencia objetivo alineada con segmento teen." },
    ],
    moodboards: [
      { id:"mb1", label:"Básicos Permanente", pct:30, code:"INSPIRACIÓN SS27", title:"BÁSICOS PERMANENTE", tagline:"BASE NEUTRA",
        tiles:[
          { label:"INSPIRACIÓN SS27", c:"#9c958a", role:"hero" },
          { label:"GALERÍA", c:"#d8d2c4" },
          { label:"TEXTURA ALGODÓN", c:"#c7c0b1" },
          { label:"COMPETENCIA", c:"#b3aa9a" },
        ],
        palette:[
          { hex:"#1a1a1a", name:"Negro base" }, { hex:"#f5f3ee", name:"Crudo" }, { hex:"#8a8a86", name:"Gris medio" },
          { hex:"#d8d2c4", name:"Arena" }, { hex:"#e8a6b8", name:"Rosa polvo" }, { hex:"#a9c4e0", name:"Azul niebla" },
        ] },
      { id:"mb2", label:"Básicos Temporada", pct:55, code:"INSPIRACIÓN PV26", title:"BÁSICOS TEMPORADA", tagline:"COLOR & FLUIDEZ",
        tiles:[
          { label:"PALETA PV26", c:"#ffbe98", role:"hero" },
          { label:"VESTIDOS MIDI", c:"#92a8d1" },
          { label:"VISCOSA FLUIDA", c:"#f4d35e" },
          { label:"STREET / REDES", c:"#f88379" },
        ],
        palette:[
          { hex:"#ffbe98", name:"Peach Fuzz" }, { hex:"#92a8d1", name:"Serenity" }, { hex:"#f4d35e", name:"Lemon Drop" },
          { hex:"#f88379", name:"Coral Reef" }, { hex:"#46b4a0", name:"Pool Green" }, { hex:"#f5f3ee", name:"Crudo" },
        ] },
      { id:"mb3", label:"Innovación", pct:15, code:"INSPIRACIÓN FWD", title:"INNOVACIÓN", tagline:"APUESTA CREATIVA",
        tiles:[
          { label:"MATERIALES TECH", c:"#5f4b8b", role:"hero" },
          { label:"NEÓN / CONTRASTE", c:"#c7e000" },
          { label:"ATHLEISURE", c:"#46b4a0" },
          { label:"CÁPSULA EDICIÓN", c:"#f96714" },
        ],
        palette:[
          { hex:"#5f4b8b", name:"Violeta" }, { hex:"#f96714", name:"Naranja" }, { hex:"#c7e000", name:"Lima neón" },
          { hex:"#46b4a0", name:"Verde piscina" }, { hex:"#1a1a1a", name:"Negro" }, { hex:"#f5f3ee", name:"Crudo" },
        ] },
    ],
